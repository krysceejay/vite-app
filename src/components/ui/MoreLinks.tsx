...
export default function MoreLinks({ setIsOpen }: MoreLinks) {
  return (
    <div className="fixed h-screen w-screen bg-overlay-color lg:hidden z-50 flex flex-col justify-end" onClick={() => setIsOpen(false)}>
      <div className="bg-[#242424] h-1/2 rounded-t-xl p-3">
